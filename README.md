...
## Environments
- Preview: https://main--aem-eds-universal-editor--AdobeDixon.aem.page/
- Live: https://main--aem-eds-universal-editor--AdobeDixon.aem.live/
...
1. Open the `aem-eds-universal-editor` directory in your favorite IDE and start coding :)
